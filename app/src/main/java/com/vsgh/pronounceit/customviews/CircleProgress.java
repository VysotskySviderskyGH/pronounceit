...
//                this.mCircleAttribute.mTextPaint.setColor(Color.WHITE);
    ...
    class CircleAttribute {
        ...
        public int mSubPaintColor = getResources().getColor(R.color.s_smoke_white);
        public int mBottomPaintColor = getResources().getColor(R.color.s_white);
        public int mMainPaintColor = getResources().getColor(R.color.s_black_transparent);
        ...
        public int mTextPaintColor = getResources().getColor(R.color.s_blue);
        ...
        public CircleAttribute() {
            ...
            this.mTextPaint.setColor(mTextPaintColor);
        ...
        public void autoFix(int width, int height) {
            this.inRoundOval.set(this.mPaintWidth / 2 + this.mSidePaintInterval,
                    ...
                    width - this.mPaintWidth / 2 - this.mSidePaintInterval,
                    height - this.mPaintWidth / 2 - this.mSidePaintInterval);
            ...
            this.mRoundOval.set(left + this.mPaintWidth / 2, top + this.mPaintWidth / 2,
                    width - right - this.mPaintWidth / 2, height - bottom - this.mPaintWidth / 2);
        }
